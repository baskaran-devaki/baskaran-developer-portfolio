...
const ContactSection = () => {
  ...
  const contactLinks = [
    ...
    { icon: FileText, label: t("contact.resume"), value: t("contact.viewResume"), href: "https://docs.google.com/document/d/1vw9lm6flPvqJuCt2zpc4p90XnDS2iwV6/edit?usp=sharing&ouid=110155258988125851637&rtpof=true&sd=true" },
  ];
